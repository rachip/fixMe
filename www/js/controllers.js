...
.controller('MarketingDetailsCtrl', function($scope, $http, $rootScope,  $ionicScrollDelegate, $cordovaSocialSharing, $ionicPopup, $q) {
	...
	$scope.share = function() {
        	...
        	var uri = "http://www.me-realestate.com"; 
        	var massage = " wanted to share with you a very interesting investment he thought you might be interested in and grant you with a 5% discount. coupon code: " + localStorage.getItem("id");
        	var title =  " shared an investment with you";
